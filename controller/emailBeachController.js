...
async function enviarCorreo(req, res) {
 const {
  ...
  const mailOptions = {
    ...
    to: "Reservastaybobeach@sthoteles.com",
    subject: 'SOLICITUD DE RESERVACIÓN PARA GRUPOS TAYBO BEACH',
    html: `
 <h2 style="text-align: center; font-family: Arial, sans-serif; color: #333">
      SOLICITUD DE RESERVACIÓN PARA GRUPOS TAYBO BEACH
    </h2>
    <table
      style="
        width: 100%;
       ...
       ${habitaciones
              .map((hab) => {
                ...
                switch (hab.acomodacion) {
                  case "habDobSen":
                    descripcionAcomodacion = "Doble 1";
                    break;
                  case "habDobMat":
                    descripcionAcomodacion = "Doble 2";
                    break;
                  case "habTri":
